 ...
 */
final class Version20241007133311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hideout ADD trip_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE hideout ADD CONSTRAINT FK_2C2FE159A5BC2E0E FOREIGN KEY (trip_id) REFERENCES trip (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_2C2FE159A5BC2E0E ON hideout (trip_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hideout DROP CONSTRAINT FK_2C2FE159A5BC2E0E');
        $this->addSql('DROP INDEX IDX_2C2FE159A5BC2E0E');
        $this->addSql('ALTER TABLE hideout DROP trip_id');
    }
}
